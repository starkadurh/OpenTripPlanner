...
public class BikeRentalUpdater extends PollingGraphUpdater {
    ...
    protected void configurePolling (Graph graph, JsonNode config) throws Exception {
        ...
        if (sourceType != null) {
            ...
            } else if (sourceType.equals("publibike")) {
                source = new PubliBikeRentalDataSource(networkName);
            } else if (sourceType.equals("limebike")) {
                source = new LimeBikeRentalDataSource(networkName);
            } else if (sourceType.equals("smidebike")) {
                source = new SmideBikeRentalDataSource(networkName);
            }
        }
